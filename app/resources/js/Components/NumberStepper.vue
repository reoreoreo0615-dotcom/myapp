...
<template>
    ...
    >
        <button
            ...
            class="flex shrink-0 items-center justify-center font-display text-2xl leading-none text-ink active:bg-surface disabled:cursor-not-allowed disabled:opacity-30"
            :disabled="modelValue <= min"
            aria-label="減らす"
            @pointerdown.prevent="onPointerDown(-1)"
